...
void setup() {
  ...
  sendATcommand("AT+CGPSURL=\"supl.google.com:7276\"", "OK", 10000);
  sendATcommand("AT+CGPSSSL=0", "OK", 5000);
  sendATcommand("AT+CGPS=0", "OK", 5000);
  sendATcommand("AT+CGPS=1,2", "OK", 5000);  
  delay(5000);
  char gpsdata[120];
...
void loop() {
  ...
  switch (command) {
    ...
    case 'S': {
        ...
        Serial.println(F("x = Exit SERIAL"));
        while (c) {
          while (Serial.available()) {
            delay(1);
            char* rc = Serial.read();            
    ...
    case 'j' :{
      Serial.println(F("Update GPS URL"));
      sendATcommand("AT+CGPSURL=\"supl.google.com:7276\"", "OK", 20000);
      sendATcommand("AT", "OK", 20000);
      sendATcommand("AT+CGPSURL?", "OK", 20000);
